  ...
  return (
    <>
      <Layout title={`Privacy Policy`} navItems={categories}>
        <div className="mx-4 mt-4 pb-4 text-sm md:p-8 xl:mx-auto xl:w-[1120px]">
          ...
          <p className="my-2">
            ...
            is collected and recorded by {SITE_META.name} and how we use it.
          </p>
          <p className="my-2">
          ...
          <p className="my-2">
            ...
            {SITE_META.name}, which are sent directly to users’ browser. They automatically receive
