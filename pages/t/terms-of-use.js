...
export default function Terms({ categories }) {
  return (
    <>
      <Layout navItems={categories} title={`Terms of Use`}>
        <div className="p-4 text-sm leading-6 xl:mx-auto xl:max-w-3xl">
          <div className="text-xl font-bold">Terms of Use</div>
          <p className="my-2">
